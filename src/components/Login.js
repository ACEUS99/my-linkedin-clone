        ...
        try {
            ...
            .then((userAuth) => {
                    ...
                    updateProfile(auth.currentUser ,{
                        ...
                        console.log("auth.currentUser.profile.email: ", auth.currentUser.profile.email)
                    })
  ...
  return (
    <div className='login--page'>
        ...
        <form>
            ...
            <input value={profilePic} onChange={e => setProfilePic(e.target.value)} placeholder="Photo URL" type="text" ></input>
